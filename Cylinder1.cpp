...
Cylinder1::Cylinder1(float baseRadius, float topRadius, float height, int radialDivision, int heightDivision, const std::string& texturePath)
...
void Cylinder1::init(float baseRadius, float topRadius, float height, int radialDivision, int heightDivision) {
...
void Cylinder1::Draw(Shader& shader, const glm::mat4& transform) {
    shader.use();
    glBindVertexArray(VAO);
...
GLuint Cylinder1::loadTexture(const char* path) {
    GLuint textureID;
